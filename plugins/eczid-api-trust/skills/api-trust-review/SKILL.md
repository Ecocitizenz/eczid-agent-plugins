...
The identical detectors, guidance and Review Priority ship in the free VS Code extension **ECZ-ID API Security** (https://marketplace.visualstudio.com/items?itemName=ecocitizenz.eczid-api-security or on Open VSX https://open-vsx.org/extension/ecocitizenz/eczid-api-security), which adds a shareable evidence summary and a local JSON + Markdown report.

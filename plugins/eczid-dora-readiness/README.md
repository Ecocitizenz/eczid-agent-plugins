...
**ECZ-ID DORA Readiness** for VS Code carries the same detectors, guidance and Review Priority, plus a shareable evidence summary and a local JSON + Markdown report: https://marketplace.visualstudio.com/items?itemName=ecocitizenz.eczid-dora-readiness (Open VSX: https://open-vsx.org/extension/ecocitizenz/eczid-dora-readiness). Product page: https://developers.ecocitizenz.com/dora/
